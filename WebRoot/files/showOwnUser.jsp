						...
						<tr>
				 		...
				 		<tr>
						  ...
						  <tr>
						    ...
						    <td><input class="text" name='psex1' style="width:154px" disabled='disabled' value="${sessionScope.user.usex==0 ? '男' : '女' }"/>
						  ...
						  <tr>
						    ...
						    <td><input class="text" name='plei1' style="width:154px" disabled='disabled' value="${sessionScope.user.ustaffType==0 ? '实习' : '在职'}"/>
