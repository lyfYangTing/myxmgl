 				...
 				$("#pronum").attr("value",'');
					...
					$("#probeginDate").attr("value",'');
						...
						$("#procompeteDate").attr("value",'');
		 				...
		 				form1.action="<%=basePath%>/projbServlet.do?op=updateProjb";
			  			form1.submit();
		 			}
			...
			<TD width="100%">
				...
				<legend>项目信息</legend>
					  ...
					  <tr>
					    ...
					    <input type="hidden" name="prno" value="${requestScope.xmglProjb.pjId }">
					    ...
					    <td width="35%"><input name='pronum' id='pronum' type="text" class="text" style="width:154px"  onblur='yanzheng("4");' value="${requestScope.xmglProjb.pjDeveloperTotal }" /></td>	
						</tr>
						<tr>	
							...
							<select name="proidcomplete" id='proidcomplete' style="width:154px"  onchange="panduan();" onblur='yanzheng("6");'>
								...
								<option <c:if test="${requestScope.xmglProjb.pjState=='进行中'}">
										selected = "selected"
										</c:if>   value="进行中">进行中
								</option>
								<option <c:if test="${requestScope.xmglProjb.pjState=='已完成'}">
										selected = "selected"
										</c:if> value="已完成">已完成
								</option>
								</select>
						...
						<tr>
						  ...
						  <td><input name='prozmoney' id='prozmoney' type="text" class="text" style="width:154px" onblur='yanzheng("7");' value="${requestScope.xmglProjb.pjSjzcb}"/></td>	
							<td nowrap="nowrap" align="right">实际开发日期:</td>
							<td><input name='probeginDate' id='probeginDate'  type="text" class="text" style="width:154px" onblur='yanzheng("8");' value="${requestScope.xmglProjb.pjSjkfTime}" /></td>
						</tr>
						<tr>
						  <td nowrap="nowrap" align="right">实际完成日期:</td>
						  <td><input name='procompeteDate' id='procompeteDate' type="text" class="text" style="width:154px" onblur='yanzheng("9");' value="${requestScope.xmglProjb.pjSjwcTime}" readonly="readonly"/></td>
