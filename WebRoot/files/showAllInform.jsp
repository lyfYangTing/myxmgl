...
$(document).ready(function(){
	...
	$("#link1").click(function(){
		...
		if(p<1){
		 ...
		 $("#fom").attr("action","<%=basePath%>/messageServlet.do?op=showAllUserInform&caozuo=sfjr&page="+p);
	});
     ...
     $("#link").click(function(){
        $("#fom").attr("action","<%=basePath%>/userServlet.do?op=getAllUsers&caozuo=sfjr");
     });
     ...
     $("#linkdel").click(function(){
     	var size = $(":checkbox").length;
			...
			for (var i=0;i<size;i++){	
	    	 ...
	    	 $("#fom").attr("action","<%=basePath %>/messageServlet.do?op=deleteSomeInform&caozuo=sfjr");
     });
...
function linkdel(){
	...
	//删除所有选中的信息
	document.getElementById("fom").action="<%=basePath%>/infoServlet.do?op=deleteAllInfo&caozuo=3&curpage=1";
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td height="40" class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="20" colspan="14" align="center" bgcolor="#EEEEEE"class="tablestyle_title"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   消息总列表  &nbsp;</td>
                    </tr>
                  <tr>
                   ...
                   <c:forEach items = "${requestScope.util.list}" var = "sendInfo">
                   		<tr>
                   			...
                   			<td bgcolor="#FFFFFF">${sendInfo.ifjr}</td>
                   			<td bgcolor="#FFFFFF">${sendInfo.iftime}</td>
                    		<td bgcolor="#FFFFFF"><a href="<%=basePath %>/messageServlet.do?op=deleteOneInform&caozuo=sfjr&id=${sendInfo.iid }">删除</a>|<a href="<%=basePath %>/messageServlet.do?op=showOneInform&caozuo=sfjr&id=${sendInfo.iid }">查看</a>
          ...
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                ...
                <td width="49%" align="right">
                 [<a href="<%=basePath %>/messageServlet.do?op=showAllUserInform&caozuo=sfjr&page=1" class="right-font08">首页</a> |
                  <a href="<%=basePath %>/messageServlet.do?op=showAllUserInform&caozuo=sfjr&page=${requestScope.curpage>1?requestScope.curpage-1:1}" class="right-font08">上一页</a> 
                | <a href="<%=basePath %>/messageServlet.do?op=showAllUserInform&caozuo=sfjr&page=${requestScope.curpage<requestScope.util.totalPage?requestScope.curpage+1:requestScope.util.totalPage}" class="right-font08">下一页</a> 
                | <a href="<%=basePath %>/messageServlet.do?op=showAllUserInform&caozuo=sfjr&page=${requestScope.util.totalPage }" class="right-font08">末页</a>] 转至：
                </td>
